...
export function LandingTabsNotes() {
  // Define three tab types
  type TabType = "appunti" | "materie";

  const [activeTab, setActiveTab] = useState<TabType>("appunti");
  ...
  const tabContent = {
    materie: {
      ...
      description:
        "Tutti i contenuti organizzati per materia e anno scolastico, per avere sempre un percorso chiaro. Il tuo amico Pit ti aiuta a risolvere dubbi e a collegare tra loro più discipline.",
      lightImage:
        "https://pmnothvdbyxdqaiyugpg.supabase.co/storage/v1/object/public/landing/light/subject-light.png",
      darkImage:
        "https://pmnothvdbyxdqaiyugpg.supabase.co/storage/v1/object/public/landing/dark/subject-dark.png",
      mobileLightImage:
        "https://pmnothvdbyxdqaiyugpg.supabase.co/storage/v1/object/public/landing/light/subject-light-mobile.png",
      mobileDarkImage:
        "https://pmnothvdbyxdqaiyugpg.supabase.co/storage/v1/object/public/landing/dark/subject-dark-mobile.png",
    },
    appunti: {
      title: "Appunti",
      description:
        "Appunti chiari e ordinati per ogni argomento, senza più perdere tempo a cercare tra mille fonti. Pit risponde alle tue domande e crea collegamenti tra gli appunti.",
      lightImage:
        "https://pmnothvdbyxdqaiyugpg.supabase.co/storage/v1/object/public/landing/light/note-light.png",
      darkImage:
        "https://pmnothvdbyxdqaiyugpg.supabase.co/storage/v1/object/public/landing/dark/note-dark.png",
      mobileLightImage:
        "https://pmnothvdbyxdqaiyugpg.supabase.co/storage/v1/object/public/landing/light/note-light-mobile.png",
      mobileDarkImage:
        "https://pmnothvdbyxdqaiyugpg.supabase.co/storage/v1/object/public/landing/dark/note-dark-mobile.png",
    },
  };

  // Get the tab order for positioning and next tab selection
  const tabOrder: TabType[] = ["materie", "appunti"];
  ...
  return (
    ...
    >
      ...
      <p className="text-center max-w-3xl text-lg text-muted-foreground mb-12">
        ...
        MaturaMente ti dà un percorso chiaro: tutto quello che ti serve, in un
        unico posto.
      </p>
      ...
      <div className="w-full flex flex-col gap-8">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-lg overflow-hidden shadow-xl min-h-[400px]">
          <div className="h-full w-full p-6">
            ...
            <div className="h-full bg-gray-50 dark:bg-neutral-800 rounded-lg w-full flex items-center justify-center overflow-hidden transition-all duration-300 ease-in-out p-4">
              {activeTab === "materie" && (
                <ThemeImage
                  lightImage={tabContent.materie.lightImage}
                  darkImage={tabContent.materie.darkImage}
                  mobileLightImage={tabContent.materie.mobileLightImage}
                  mobileDarkImage={tabContent.materie.mobileDarkImage}
                  alt={tabContent.materie.title}
              ...
              {activeTab === "appunti" && (
                <ThemeImage
                  lightImage={tabContent.appunti.lightImage}
                  darkImage={tabContent.appunti.darkImage}
                  mobileLightImage={tabContent.appunti.mobileLightImage}
                  mobileDarkImage={tabContent.appunti.mobileDarkImage}
                  alt={tabContent.appunti.title}
                  className="w-full h-full object-contain rounded-md shadow-lg transition-transform duration-300 hover:scale-[1.02]"
                  mobileBreakpoint={768}
                  width={1200}
                  height={800}
        ...
        <div ref={tabsContainerRef} className="relative w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 w-full md:border-t md:border-gray-100 dark:md:border-neutral-800">
            {/* Experience Tab */}
            <button
              onClick={() => handleTabClick("materie")}
              className={`relative text-left p-6 transition-all duration-300 focus:outline-none dark:border-neutral-800 ${
                activeTab === "materie" ? "bg-gray-50 dark:bg-neutral-800" : ""
              }`}
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  {tabContent.materie.title}
                </h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {tabContent.materie.description}
                </p>
              </div>
            </button>
            ...
            {/* Timeline Tab */}
            <button
              onClick={() => handleTabClick("appunti")}
              className={`relative text-left p-6 transition-all duration-300 focus:outline-none dark:border-neutral-800 ${
                activeTab === "appunti" ? "bg-gray-50 dark:bg-neutral-800" : ""
              }`}
            >
              {/* Mobile progress indicator - only visible on mobile */}
              <div className="absolute top-0 left-0 w-full h-0.5 bg-trasparent dark:bg-neutral-700 md:hidden">
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  {tabContent.appunti.title}
                </h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {tabContent.appunti.description}
                </p>
              </div>
            </button>
          </div>
