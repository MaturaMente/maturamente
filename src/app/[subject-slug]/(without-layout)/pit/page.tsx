...
export async function generateMetadata({
  ...
  if (!subjectSlug) {
    return {
      title: "Pit - Tutor AI",
      description: "Chatta con Pit, il tutor AI di MaturaMente per ricevere aiuto personalizzato nello studio di tutte le materie scolastiche.",
    };
  }
  ...
  try {
    ...
    if (!subject) {
      return {
        title: "Pit - Tutor AI",
        description: "Chatta con Pit, il tutor AI di MaturaMente per ricevere aiuto personalizzato nello studio.",
      };
    }
